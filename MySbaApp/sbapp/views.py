...
class AdminLoginView(LoginView):
    ...
    def form_valid(self, form):
        ...
        try:
            fastapi_url = "http://ussba-fastapi.francecentral.azurecontainer.io//auth/login"
            auth_data = {
                "email": email,
                "password": password,
            }
...
def get_jwt_token(request):
    ...
    response = requests.post(
        'http://ussba-fastapi.francecentral.azurecontainer.io/auth/login',
...
class AdminLoanRequestView(LoginRequiredMixin, ListView):
    ...
    def handle_prediction(self, loan_id, request):
        ...
        if response := send_api_request(
            'http://ussba-fastapi.francecentral.azurecontainer.io/loans/request',
            'POST',
            data=api_data,
            headers=headers,
        ):
