...
class AdvisorLoanListView(LoginRequiredMixin, ListView) : 
    model = LoanRequest
    template_name = 'sbapp/customer_loan_list.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        for loan_request in context["loan_requests"] :
            ...
            loan_request.custom_simulation_date = loan_request.loan_simulation_date
            ...
            loan_request.custom_advisor_approval_date = loan_request.loan_advisor_approval_date
